<template>
  <div class="city_body">
        ...
        <div>
          ...
          <div class="city_sort" ref="city_sort">
            <div v-for="item of cityList" :key="item.id">
                <h2>{{item.index}}</h2>
                <ul>
                <li v-for="itemlist of item.list" :key="itemlist.id" @tap='handleToCity(itemlist.nm, itemlist.id)'>{{itemlist.nm}}</li>
                </ul>
            </div>
        </div>
      </div>
    ...
    <div class="city_index">
      <ul>
      <li v-for="(item,index) of cityList" :key="item.id" @touchstart="handleToIndex(index)">{{item.index}}</li>
      </ul>
    </div>
  </div>
</template>
